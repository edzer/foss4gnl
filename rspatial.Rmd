...
* will use Google's [s2geometry.io](https://s2geometry.io) library, which also powers G Maps, G Earth, G Earth Engine and G Bigquery GIS
...
* OGC _should_ only produce good standards, but _can't_, because its organisational model (closed, membership levels) allows strong partners to push for software or platform lock-ins: plutocracy
* OGC also _evolves_ standards, which breaks things, and introduces complexity (axis order: anyone?)
...
- Get involved, on [github.com/r-spatial](https://github.com/r-spatial/) or [r-spatial.org](https://www.r-spatial.org/)
...
- Always challenge those who tell you what your foundations are
- We need to bring up the discussion about what _standards lock-in_ means
